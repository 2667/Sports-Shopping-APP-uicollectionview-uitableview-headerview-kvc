...
@interface XMGStatusBarViewController () <NSCopying>

@end

@implementation XMGStatusBarViewController
#pragma mark - 单例
static id instance_;
...
+ (void)show
{
    ...
    window_.rootViewController = [[XMGStatusBarViewController alloc] init];
    /*
     窗口级别:
