...
@interface TZXXVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TZXXCell * cell = [tableView dequeueReusableCellWithIdentifier:str];
    if (cell == nil) {
        
        cell = [[TZXXCell alloc] initWithStyle: UITableViewCellStyleDefault reuseIdentifier:str];
    }
    ...
    cell.biaoting.text = @"您的订单已被接单";
    cell.biaoting.textColor = WenZiHeiColor;
    cell.biaoting.font = [UIFont systemFontOfSize:16];
    
    
    cell.hongdian.backgroundColor = [UIColor redColor];
    cell.hongdian.layer.cornerRadius = 5;
    cell.hongdian.layer.masksToBounds = YES;
    


    cell.zhutu.backgroundColor = [UIColor orangeColor];
    
    
    cell.neirong.text = @"亲~ 您的订单已被某某接单。";
