...
//        self.titleColor = [UIColor blackColor];
       self.titleColor = [UIColor colorWithRed:153/255.0f green:153/255.0f blue:153/255.0f alpha:1.0f];
        self.titleFontSize = 15;
        // cell的图片的尺寸
//        self.iconSize = CGSizeMake(30, 30);
        self.iconSize = CGSizeMake(17, 17);
        //cell中图片的左边距
//        self.iconLeftMargin = 10;
//        self.iconLeftMargin = 37.5;
...
//        self.menuWidth = 150;
        ...
        self.menuWidth = 130;
        //tableView的宽度
//          self.menuWidth = [UIScreen mainScreen].bounds.size.width-20;
        
//        self.menuCornerRadius = 5;
        self.menuCornerRadius = 2.5;
//        self.eachMenuItemHeight = 40;
//        self.eachMenuItemHeight = 44.1667;
        
        self.eachMenuItemHeight = 40.8333;
...
//        self.triangleSize = CGSizeMake(18, 10);
        self.triangleSize = CGSizeMake(10, 10);
...
+ (instancetype)ff_DefaultStyleDropDownMenuWithMenuModelsArray:(NSArray *)menuModelsArray menuWidth:(CGFloat)menuWidth eachItemHeight:(CGFloat)eachItemHeight menuRightMargin:(CGFloat)menuRightMargin triangleRightMargin:(CGFloat)triangleRightMargin clickedButtonItem:(UIBarButtonItem *)clickedButtonItem{
    ...
    menuView.clickedButtonItem = clickedButtonItem;
...
//    horizonWidth - (self.triangleRightMargin + self.triangleSize.width/2)
//    self.triangleView.frame = CGRectMake(_clickedButtonItem.customView.center.x - self.triangleSize.width/2, self.realTriangleY, self.triangleSize.width, self.triangleSize.height);
    
//    _clicedBtnCenterPoint
    //三角形中心点
//    self.triangleView.center = CGPointMake(horizonWidth - self.triangleRightMargin, self.triangleView.center.y);
    
//    _clickedButtonItem;
//    _clickedButtonItem.customView.center;
//    _clickedButtonItem.width;
    
    NSLog(@"_clickedButtonItem.customView.center%f",_clickedButtonItem.customView.center.x);
//     self.triangleView.center = CGPointMake(_clickedButtonItem.customView.center.x, self.triangleView.center.y);
//    self.triangleView.center = CGPointMake(horizonWidth- _clickedButtonItem.customView.center.x-_triangleRightMargin, self.triangleView.center.y);
    
//    10是按钮宽度的一半,_triangleRightMargin是按钮右侧边距.在5s上距离还需要调一下.
//    self.triangleView.center = CGPointMake(horizonWidth- 10-_triangleRightMargin, self.triangleView.center.y);
    
    //--320*480 是 iPhone1/3/3gs的设备分辨率
    if (iPhone(320, 480)) {
        self.triangleView.center = CGPointMake(horizonWidth- 5-_triangleRightMargin, self.triangleView.center.y);
    }
    //--750x1334 是 iPhone4或iPhone4s 的设备分辨率
   else if (iPhone(640, 960)) {
       self.triangleView.center = CGPointMake(horizonWidth- 5-_triangleRightMargin, self.triangleView.center.y);
    }
    //--640x1136 是 iPhone5或iPhone5s 的设备分辨率
    else if (iPhone(640, 1136)) {
        self.triangleView.center = CGPointMake(horizonWidth- 5-_triangleRightMargin, self.triangleView.center.y);
    }
    //--750x1334 是 iPhone6或iPhone6s 的设备分辨率
    else if (iPhone(750, 1334)) {
        self.triangleView.center = CGPointMake(horizonWidth- 7.5-_triangleRightMargin, self.triangleView.center.y);
    }else if (iPhone(1080, 1920) || [UIScreen mainScreen].bounds.size.width>=1080) {
        //--1080*1920 是 iPhone6plus 的设备分辨率
        self.triangleView.center = CGPointMake(horizonWidth- 10-_triangleRightMargin, self.triangleView.center.y);
    ...
    NSLog(@"menuWidth值是%f",self.menuWidth);
...
//        tempCell.titleColor = self.titleColor;
        tempCell.titleColor = [UIColor colorWithRed:153/255.0f green:153/255.0f blue:153/255.0f alpha:1.0f];
...
//            tempCell.customImageView.hidden = YES;
            //        CGRect frame1 = cell.customImageView.frame;
            CGRect frame2 = tempCell.frame;
//            tempCell.customTitleLabel.translatesAutoresizingMaskIntoConstraints = NO;
            //        cell.customTitleLabel.frame = CGRectMake(20, frame2.origin.y, frame2.size.width, frame2.size.height);
//            tempCell.customTitleLabel.frame = CGRectMake(20, frame2.origin.y, frame2.size.width/2, frame2.size.height/2);
            
            UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(10, frame2.origin.y, frame2.size.width, frame2.size.height)];
//                label.backgroundColor = [UIColor redColor];
            ...
            tempCell.faBiaoLabel = label;
            [tempCell addSubview:label];
