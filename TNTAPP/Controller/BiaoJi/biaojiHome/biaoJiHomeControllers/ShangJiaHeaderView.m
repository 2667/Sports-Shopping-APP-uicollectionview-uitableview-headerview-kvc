...
@implementation ShangJiaHeaderView
...
+(ShangJiaHeaderView*)instance{
    ...
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"ShangJiaHeaderView" owner:nil options:nil];
    
    ShangJiaHeaderView * view1 = [nibArray objectAtIndex:0];
