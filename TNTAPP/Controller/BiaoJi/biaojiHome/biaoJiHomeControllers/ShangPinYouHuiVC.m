...
//@property (nonatomic, strong)ShangJiaAddView *XinJianZuView;
...
@implementation ShangPinYouHuiVC
...
static NSString * const reuseIdentifier = @"YouHuiCollectionViewCell";
...
//    _DeleteView.AddBtn.TitleLabel.text = @"添加商品";
    _DeleteView.DeleteBtn.TitleLabel.textColor = [UIColor yellowColor];
    _DeleteView.AddBtn.TitleLabel.textColor = [UIColor lightGrayColor];
...
-(void)AddBtnClicked{
    ...
    _DeleteView.DeleteBtn.TitleLabel.textColor = [UIColor lightGrayColor];
    _DeleteView.AddBtn.TitleLabel.textColor = [UIColor yellowColor];
}
...
-(ShangJiaDeleteView *)DeleteView{
    ...
    //    languageView.imageIcon.image = [UIImage imageNamed:@"Language icon"];
     ...
     _DeleteView.DeleteBtn.view.userInteractionEnabled=YES;
      UITapGestureRecognizer *labelTapGestureRecognizer = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(DeleteBtnClicked)];
    
     [_DeleteView.DeleteBtn.view addGestureRecognizer:labelTapGestureRecognizer];
    _DeleteView.DeleteBtn.TitleLabel.text = @"删除商品";
    
    _DeleteView.AddBtn.view.userInteractionEnabled=YES;
    UITapGestureRecognizer *labelTapGestureRecognizer2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(AddBtnClicked)];
    
    [_DeleteView.AddBtn.view addGestureRecognizer:labelTapGestureRecognizer2];
    _DeleteView.AddBtn.TitleLabel.text = @"添加商品";
    _DeleteView.AddBtn.TitleLabel.textColor = [UIColor lightGrayColor];
...
//        [_collectionView registerClass:[tbCollectionViewCell class] forCellWithReuseIdentifier:@"Cell"];
        [_collectionView registerClass:[YouHuiCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    YouHuiCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
{
//    cell的高度大约是宽度的1.64倍
    return CGSizeMake((SCREEN_WIDTH-40)/3, 1.95*(SCREEN_WIDTH-40)/3);
}
...
//    NSLog(@"section===%ld",(long)indexPath.section);
    ...
    BianJiPhotoViewController *ShangJiaShiJinVC1 = [[BianJiPhotoViewController alloc]init];
