...
//@protocol ShangJiaHeaderViewDelegate <NSObject>
//
...
@interface ShangJiaHeaderView : UIView
//@property (weak, nonatomic) IBOutlet UIImageView *icon;

//@property(nonatomic,weak)id<ShangJiaHeaderViewDelegate> delegate;
//头像
...
@property (weak, nonatomic) IBOutlet UILabel *foodTextLabel;


+(ShangJiaHeaderView*)instance;
