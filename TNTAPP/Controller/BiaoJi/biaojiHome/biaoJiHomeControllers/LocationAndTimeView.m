...
#import "LocationAndTimeView.h"

@implementation LocationAndTimeView
...
-(void)setup{
     [[NSBundle mainBundle] loadNibNamed:@"LocationAndTimeView" owner:self options:nil];
    
_youhuiLabel.layer.cornerRadius = 3;
    
    //设置为yes，就可以使用圆角
    _youhuiLabel.layer.masksToBounds = YES;
