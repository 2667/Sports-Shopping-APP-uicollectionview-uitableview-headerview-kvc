...
@implementation ShangJiaAddView
...
+(ShangJiaAddView*)instance{
    ...
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"ShangJiaAddView" owner:nil options:nil];
    
    ShangJiaAddView * view1 = [nibArray objectAtIndex:0];
