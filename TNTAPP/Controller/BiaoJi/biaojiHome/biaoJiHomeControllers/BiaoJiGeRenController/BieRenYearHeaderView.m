...
@implementation BieRenYearHeaderView
...
+(BieRenYearHeaderView*)instance{
    ...
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"BieRenYearHeaderView" owner:nil options:nil];
    
    BieRenYearHeaderView * view1 = [nibArray objectAtIndex:0];
