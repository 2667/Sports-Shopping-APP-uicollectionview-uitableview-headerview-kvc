...
@interface xiangCeLieBiaoBieRenVC ()

// 全局记录当前应该显示图片的索引
@property (nonatomic, assign) NSInteger currentIndex;
@end

@implementation xiangCeLieBiaoBieRenVC
...
//    titleLabel.font = [UIFont systemFontOfSize:20];
          ...
          UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(margin, 24,40, 40)];
    ...
    UIButton *rightButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-margin-40, 24,40, 40)];
    [rightButton setImage:[UIImage imageNamed:@"biaojishouye_fabiao"] forState:UIControlStateNormal];
    
    [rightButton addTarget:self action:@selector(rightMoreButtonClicked:)
     forControlEvents:UIControlEventTouchUpInside];
...
-(void)rightMoreButtonClicked:(UIButton*)btn{
