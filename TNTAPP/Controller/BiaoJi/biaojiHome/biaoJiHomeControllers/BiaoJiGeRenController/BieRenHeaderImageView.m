...
@implementation BieRenHeaderImageView
...
+(BieRenHeaderImageView*)instance{
    ...
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"BieRenHeaderImageView" owner:nil options:nil];
    
    BieRenHeaderImageView * view1 = [nibArray objectAtIndex:0];
