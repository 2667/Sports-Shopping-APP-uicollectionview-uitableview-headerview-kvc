...
@interface SiXinViewController ()<UITableViewDelegate,UITableViewDataSource,FFDropDownMenuViewDelegate>
...
-(UITableView *)tableView{
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-22) style:UITableViewStylePlain];
    _tableView.backgroundColor = [UIColor blackColor];
//    SiXinTableViewCell
    UINib *cellNib = [UINib nibWithNibName:@"SiXinTableViewCell" bundle:nil];
    
    [_tableView registerNib:cellNib forCellReuseIdentifier:@"SiXinTableViewCell"];
...
//    UINib *cellNib = [UINib nibWithNibName:@"GeRenGuanZuTableViewCell" bundle:nil];
//    [tableView registerNib:cellNib forCellReuseIdentifier:@"GeRenGuanZuTableViewCellID"];
        ...
        if (!cell) {
            cell = [SiXinTableViewCell returnCell];
        }
...
//        if (indexPath.row==0) {
//            cell.zaiXianKeFuLabel.hidden =NO;
//            cell.nameLabel.hidden = YES;
//            cell.detailTextLabel.hidden = YES;
//            
//        }else{
//            cell.zaiXianKeFuLabel.hidden =YES;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    duiHuaViewController * guanZuViewC = [[duiHuaViewController alloc]init];
...
- (void)setupDropDownMenu:(UIBarButtonItem*)btnItem {
    ...
    self.dropdownMenu.iconRightMargin = 10;
     self.dropdownMenu.triangleY = 65;
    self.dropdownMenu.backgroundColor = [UIColor colorWithRed:64/255.0f green:70/255.0f blue:79/255.0f alpha:1.0];
    //如果有需要，可以设置代理（非必须）
