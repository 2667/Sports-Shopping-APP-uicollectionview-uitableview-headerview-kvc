...
@implementation ShangJiaShiJinVC
...
-(void)rightAddButtonClicked:(UIButton*)btn{
    if (!_XinJianZuView) {
        [self.view addSubview:self.XinJianZuView];
             ...
             usingSpringWithDamping:0.9
              initialSpringVelocity:1
                         ...
                         animations:^{
                           ...
                           _XinJianZuView.frame = CGRectMake((SCREEN_WIDTH-255)/2, (SCREEN_HEIGHT-155)/2,255, 155);
        ...
        [_XinJianZuView removeFromSuperview];
        _XinJianZuView=nil;
...
-(ShangJiaAddView *)XinJianZuView{

    if (!_XinJianZuView) {}
    _XinJianZuView = [ShangJiaAddView instance];
    
    _XinJianZuView.frame = CGRectMake((SCREEN_WIDTH-255)/2, SCREEN_HEIGHT,255, 155);
//     _XinJianZuView.frame = CGRectMake((SCREEN_WIDTH-255)/2, (SCREEN_HEIGHT-155)/2,0, 0);
//    languageView.imageIcon.image = [UIImage imageNamed:@"Language icon"];

    return _XinJianZuView;
}
...
{
    return CGSizeMake((SCREEN_WIDTH-35)/4, (SCREEN_WIDTH-35)/4);
}
...
//    NSLog(@"section===%ld",(long)indexPath.section);
    ...
    FenZuImagesVC *ShangJiaShiJinVC1 = [[FenZuImagesVC alloc]init];
