...
@implementation PinJiaHeaderView
...
+(PinJiaHeaderView*)instance{
    
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"PinJiaHeaderView" owner:nil options:nil];
    
    PinJiaHeaderView * view1 = [nibArray objectAtIndex:0];
