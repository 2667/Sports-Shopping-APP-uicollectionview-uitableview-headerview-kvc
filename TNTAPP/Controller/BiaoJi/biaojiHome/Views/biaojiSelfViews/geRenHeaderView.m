...
@implementation geRenHeaderView
...
+(geRenHeaderView*)instance{
    
    NSArray*nibArray = [[NSBundle mainBundle] loadNibNamed:@"geRenHeaderView" owner:nil options:nil];
    
    geRenHeaderView * view1 = [nibArray objectAtIndex:0];
